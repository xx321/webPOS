...
<body>
	<div class="center">
		...
		<div id="main">
			...
			<s:form id="cmxform" action="updateCustomer" namespace="/admin" theme="simple">
				<fieldset>
					<legend></legend>
					...
					<p>
						...
						<input  name="customer.companyCode" value="${customer.companyCode}" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">客戶名稱:</label>
						<input  name="customer.name" value="${customer.name}" size="20" maxlength="20" class="required"/>
					</p>
					<p>
						<label id="add1">聯絡人:</label>
						<input  name="customer.contact" value="${customer.contact}" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">電話:</label>
						<input  name="customer.phone" value="${customer.phone}" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">傳真:</label>
						<input  name="customer.fax" value="${customer.fax}" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">電子郵件:</label>
						<input  name="customer.email" value="${customer.email}" size="30" maxlength="30"/>
					</p>
					<p>
						<label id="add1">狀態:</label>
					</p>
					
					<s:radio name="customer.status" list="#{'1':'開啟','0':'禁用'}"/>
					<p>
