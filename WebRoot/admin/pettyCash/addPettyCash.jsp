...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		document.supplierForm.paymentTimeStr.value = nowStr;
			...
			<fieldset>
				<div id="r1">
					...
					<form name="supplierForm">
						...
						<p>
							<label>廠商:</label> <input name="name" size="20" maxlength="20" readonly="readonly">
								<span> 
						...
						<p>
							<label>經辦人:</label> <input value="${user.username}" name="username" size="20"
								maxlength="20">
						</p>
						...
						<p>
							<label>支出帳戶:</label> <input value="現金支出" name="paymentAccount" size="20" maxlength="20" readonly="readonly">
						</p>
						<p>
							<label>支出日期:</label> <input id="paymentTimeStr" name="paymentTimeStr" size="20" maxlength="20" readonly="readonly">
				...
				<div id="r2">
					<s:form name="objectForm" action="addPettyCash"
						namespace="/admin">
						...
						<input type=hidden name="salesTax">
						<input type=hidden name="totalAmount">
						<input type=hidden name="paymentAccount">
						<input type=hidden name="paymentTimeStr">
