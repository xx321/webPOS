	...
	if (rows.length > 0) {
		parent.sy.messagerConfirm('請確認', '您要刪除當前所選項目 ? ', function(r) {
			if (r) {
				...
				$.ajax({
					url : '${pageContext.request.contextPath}/admin/deleteCustomer',
					data : {
						ids : ids.join(',')
					},
					dataType : 'json',
...
<body>
<s:form name="editForm" action="editCustomer" namespace="/admin" >
...
<div id="toolbar"style="height: 100px;">
	...
	<div class="center">
		...
		<div id="main">
			...
			<p align="center">
				<button type="button"
					onclick="self.location.href='admin/customer/addCustomer.jsp'">
					<h6>添加客戶</h6>
					<p>請檢查後再按下按鈕。</p>
				</button>
