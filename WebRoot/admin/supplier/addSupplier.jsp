...
<body>
	<div class="center">
		...
		<div id="main">
			...
			<s:form id="cmxform" action="addSupplier" namespace="/admin" theme="simple">
			<fieldset>
					<legend></legend>
					...
					<p>
						...
						<input  name="supplier.companyCode" size="20" maxlength="20" class="required"/>
					</p>
					<p>
						<label id="add1">供應商名稱:</label>
						<input  name="supplier.name" size="20" maxlength="20" class="required"/>
					</p>
					<p>
						<label id="add1">聯絡人:</label>
						<input  name="supplier.contact" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">電話:</label>
						<input  name="supplier.phone" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">傳真:</label>
						<input  name="supplier.fax" size="20" maxlength="20"/>
					</p>
					<p>
						<label id="add1">電子郵件:</label>
						<input  name="supplier.email" size="30" maxlength="30"/>
					</p>
					<p>
						<label id="add1">狀態:</label>
					</p>
					
					<s:radio name="supplier.status" list="#{'1':'開啟','0':'禁用'}" value="1"/>
					...
					<p>
						...
						<input  name="supplier.agencyName" size="25" maxlength="25"/>
					</p>
					<p>
						<label id="add1">戶名:</label>
						<input  name="supplier.accountUsername" size="25" maxlength="25"/>
					</p>
					<p>
						<label id="add1">總分支機構代碼:</label>
						<input  name="supplier.agencyCode" size="15" maxlength="15"/>
					</p>
					<p>
						<label id="add1">帳號:</label>
						<input  name="supplier.account" size="20" maxlength="20"/>
					</p>
