...
<body>
	<div class="center">
		...
		<div id="main">
			...
			<s:form id="cmxform" action="updateCategory" namespace="/admin" theme="simple">
				<fieldset>
					<legend></legend>
					...
					<p>
						...
						<input value="${category.name}" name="category.name" size="20" maxlength="20" class="required"/>
					</p>
					<p>
						<label id="add1">顯示順序:</label>
						<input value="${category.displayOrder}" name="category.displayOrder" size="2" maxlength="2" class="required"/>
					</p>
					<p>
						<label id="add1">狀態:</label>
					</p>
					
					<s:radio name="category.status" list="#{'1':'開啟','0':'禁用'}" />
