...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/admin/datagridCategory',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
			pageSize : 10,
...
<body>
<s:form name="editForm" action="editCategory" namespace="/admin" >
...
<h2>分類設定</h2>
		<div id="main">
			...
			<p align="center">
				<button type="button"
					onclick="self.location.href='admin/category/addCategory.jsp'">
					<h6>添加分類</h6>
					<p>請檢查後再按下按鈕。</p>
				</button>
