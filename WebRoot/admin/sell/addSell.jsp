...
<script type="text/javascript" charset="utf-8">
	...
	function listCustomerOpen() {
		...
		$('#sustomer_searchForm').find('input').val('');
	...
	<div class="center">
		...
		<div id="main">
			<fieldset>
				<div id="r1">
					...
					<form name="customerForm">
						...
						<p>
							<label>客戶名稱:</label> <input name="name" size="20" maxlength="20" readonly="readonly">
						</p>
						<p>
				...
				<div id="r2">
					<s:form name="objectForm" action="addSell"
						namespace="/admin">
						...
						<p>
							<textarea name="delivery" rows="4" cols="40"></textarea>
						</p>
						<p>
							<label>備註:</label>
						</p>
						...
						<p>
							...
							<s:radio name="status" list="#{'1':'已收現','0':'未收款'}" value="0"/>
			...
			<fieldset id="bads">
				...
				<button type="button" onclick="self.location.href='admin/sell.jsp'">
