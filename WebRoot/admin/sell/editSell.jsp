	...
	<div class="center">
		...
		<div id="main">
			<fieldset>
				...
				<div id="r2">
					<s:form name="objectForm" action="updateSell"
						namespace="/admin">     
						...
						<p>
							<textarea name="delivery" rows="4" cols="40">${sell.delivery}</textarea>
						</p>
						<p>
							<label>備註:</label>
						</p>
						<p>
							<textarea name="description" rows="4" cols="40">${sell.description}</textarea>
						</p>
						<p>
							<label>付款狀態:</label>
						</p>
							<s:radio name="status" list="#{'1':'已收現','0':'未收款'}" value="sell.status"/>
