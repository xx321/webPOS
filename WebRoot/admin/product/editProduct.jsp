...
<body>
	...
	<div class="center">
		...
		<div id="main">
			...
			<s:form id="cmxform" action="updateProduct" namespace="/admin" theme="simple">
				<fieldset>
					<legend></legend>
					...
					<s:radio name="product.type" list="#{'1':'庫存商品','0':'非庫存商品'}" />
					...
					<p>
						...
						<s:textfield name="product.displayOrder" size="2" maxlength="2" />
					</p>
					<p>
						<label id="add1">條碼編號:</label> 
						<s:textfield name="product.barcodeNumber" size="20" maxlength="20" readonly="true" />
					...
					<s:radio name="product.status" list="#{'1':'開啟','0':'禁用'}" />
