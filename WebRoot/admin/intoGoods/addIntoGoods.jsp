	...
	<div class="center">
		...
		<div id="main">
			<fieldset>
				<div id="r1">
					...
					<form name="supplierForm">
						<p>
							<label>統一編號:</label> <input name="companyCode" size="20"
								maxlength="20" readonly="readonly"> <span> <a
								href="javascript:void(0)" onclick="listSupplierOpen();"><img
									src="images/firm.png" width="25" height="25" /> </a> </span>
						</p>
						<p>
							<label>廠商名稱:</label> <input name="name" size="20" maxlength="20"
								readonly="readonly">
						</p>
						<p>
						...
						<p>
							<label>電話:</label> <input name="phone" size="20" maxlength="20"
								readonly="readonly">
						</p>
						<p>
							<label>傳真:</label> <input name="fax" size="20" maxlength="20"
								readonly="readonly">
						</p>
						<p>
					...
					<form name="taxForm">
						<input type="checkbox" name="taxChoice"
							onclick="choiceTax(this.form)">含稅
						<p>
					</form>
				</div>
				<div id="r2">
					<s:form name="objectForm" action="addIntoGoods" namespace="/admin">
						...
						<p>
							<label id="add1">發票號碼:</label> <input name="invoiceNumber"
			...
			<fieldset id="bads">
				...
				<button type="button"
					onclick="self.location.href='admin/intoGoods.jsp'">
