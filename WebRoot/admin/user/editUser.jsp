...
<body>
	<div class="center">
		...
		<div id="main">
			...
			<s:form action="updateUser" namespace="/admin" theme="simple">
				<fieldset>
					<legend></legend>
					...
					<p>
						<label>帳號:</label>
						<s:textfield name="user.account" size="20" maxlength="20" readonly="true"/>
					</p>		
					<p>
						<label>密碼:</label>
					...
					<s:radio name="user.status" list="#{'1':'在職','0':'離職'}" />

					<p>
						<label>權限:</label>
					</p>
					<s:radio name="user.purview" list="#{'1':'管理員','0':'操作員'}" />
